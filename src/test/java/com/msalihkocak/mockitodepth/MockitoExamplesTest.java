package com.msalihkocak.mockitodepth;
...
public class MockitoExamplesTest {
    ...
    public void exampleTest(){
        ...
        for(int i = 0; i < 5; i++)
            System.out.println(someInterface.getMatchingSize(5,6));
    }
    ...
    public void spying() {
        ...
        verify(set).add(31);
        verify(set, timeout(100).atLeast(99)).iterator();
    ...
    public void bddMockito() throws Exception {
        ...
        /*given(someInterface.isFileValid("myFile"))
                .willReturn(true);*/
        when(someInterface.isFileValid("myFile")).thenReturn(true);
